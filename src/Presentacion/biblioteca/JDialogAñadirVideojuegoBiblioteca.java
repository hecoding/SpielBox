...
public class JDialogAñadirVideojuegoBiblioteca extends JDialog {

	public JDialogAñadirVideojuegoBiblioteca(){
		initComponents();
	}
	...
	private void initComponents() {
        ...
        setTitle("Añadir videojuego a biblioteca");
        ...
        jButtonAñadir.addActionListener(new ActionListener() {			
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				TransferVideojuego addVideo = (TransferVideojuego) JPanelBiblioteca.getModeloVideojuegoBiblioteca().getItem(jTableVideojuegos.getSelectedRow());
				...
				transferVideojuego_biblioteca.add(addVideo);
				transferVideojuego_biblioteca.add(modBiblioteca);
				ControladorAplicacion.getInstance().accionCommand(Eventos.AÑADIR_VIDEOJUEGO_BIBLIOTECA, transferVideojuego_biblioteca);
				setVisible(false);
			}
        });
